...
require_once($CFG->dirroot . "/blocks/custom_textstickers/renderer.php");
class block_custom_textstickers extends block_base {
    public function init() {
        $this->title = get_string('custom_textstickers', 'block_custom_textstickers');
    }
    public function get_content() {
        global $OUTPUT, $CFG, $DB;
        $this->content = new stdClass;
        $html = render_textstickers();
        $templatecontext = [];
        ...
        $this->content->text .= $OUTPUT->render_from_template('block_custom_textstickers/blockcontent', $templatecontext);
