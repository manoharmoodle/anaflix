...
require_once($CFG->dirroot . "/blocks/custom_textlinkstickers/renderer.php");
class block_custom_textlinkstickers extends block_base {
    public function init() {
        $this->title = get_string('custom_textstickers', 'block_custom_textlinkstickers');
    }
    public function get_content() {
        global $OUTPUT, $CFG, $DB;
        $this->content = new stdClass;
        $html = render_textlinkstickers();
        $templatecontext = [];
        $templatecontext['blockstyle'] = $CFG->wwwroot . '/blocks/custom_textstickers/style.css';
        ...
        $this->content->text .= $OUTPUT->render_from_template('block_custom_textlinkstickers/blockcontent', $templatecontext);
