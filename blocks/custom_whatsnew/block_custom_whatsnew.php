...
class block_custom_whatsnew extends block_base {
    public function init() {
        $this->title = get_string('custom_whatsnew', 'block_custom_whatsnew');
    }
    public function get_content() {
        global $OUTPUT, $CFG;
        $this->content = new stdClass;
        $html = render_custom_whatsnew(custom_get_maximum_active_user_in_course(10));
        $templatecontext = [];
        $templatecontext['blockstyle'] = $CFG->wwwroot . '/blocks/custom_whatsnew/style.css';
        ...
        $this->content->text .= $OUTPUT->render_from_template('block_custom_whatsnew/blockcontent', $templatecontext);
