...
namespace block_custom_whatsnew\external;
...
trait set_block_config {
    ...
    public static function set_block_config($instanceid, $blockhtml, $blockcss, $blockjs) {
        ...
        $returnobj->msg = get_string('changessaved', 'block_custom_whatsnew');

        if (!$blockrecord) {
            $returnobj->status = true;
            $returnobj->msg = get_string('instancenotfound', 'block_custom_whatsnew');
            return $returnobj;
        }
