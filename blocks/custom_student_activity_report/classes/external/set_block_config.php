...
namespace block_custom_student_activity_report\external;
...
trait set_block_config {
    ...
    public static function set_block_config($instanceid, $blockhtml, $blockcss, $blockjs) {
        ...
        $returnobj->msg = get_string('changessaved', 'block_custom_student_activity_report');

        if (!$blockrecord) {
            $returnobj->status = true;
            $returnobj->msg = get_string('instancenotfound', 'block_custom_student_activity_report');
            return $returnobj;
        }
