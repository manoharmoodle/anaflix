...
require_once($CFG->dirroot . "/blocks/custom_student_activity_report/renderer.php");
class block_custom_student_activity_report extends block_base {
    public function init() {
        $this->title = get_string('custom_student_activity_report', 'block_custom_student_activity_report');
    }
    public function get_content() {
        ...
        if (is_siteadmin()) {
            ...
            $html = render_LeaderBoard(10);
        }

        $templatecontext = [];
        $templatecontext['blockstyle'] = $CFG->wwwroot . '/blocks/custom_student_activity_report/style.css';
        ...
        $this->content->text .= $OUTPUT->render_from_template('block_custom_student_activity_report/blockcontent', $templatecontext);
