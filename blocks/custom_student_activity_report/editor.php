...
global $CFG, $OUTPUT;
require_once($CFG->dirroot . "/blocks/custom_student_activity_report/lib.php");

require_login();
$blockinstance = required_param('bui_edit', PARAM_INT);
require_capability(
    "block/custom_student_activity_report:cancustomizelive",
...
$config = block_custom_student_activity_report_get_config($blockinstance);
$templatecontext = [];
...
echo $OUTPUT->render_from_template('block_custom_student_activity_report/blockpage', $templatecontext);
