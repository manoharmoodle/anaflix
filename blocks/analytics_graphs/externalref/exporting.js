...
(function (m) {
  ...
  (function (f) {
    ...
    f.post = function (a, b, e) {
      ...
      a = r(
        "form",
        q({ method: "post", action: a, enctype: "multipart/form-data" }, e),
        { display: "none" },
        n.body
      );
      for (c in b)
    ...
    t(u.prototype, {
      ...
      getSVG: function (a) {
        ...
        n.createElementNS ||
          (n.createElementNS = function (a, b) {
        ...
        p &&
          (c = g.match(/<\/svg>(.*?$)/)) &&
          ((c =
            '\x3cforeignObject x\x3d"0" y\x3d"0" width\x3d"200" height\x3d"200"\x3e\x3cbody xmlns\x3d"http://www.w3.org/1999/xhtml"\x3e' +
            c[1] +
      ...
      getSVGForExport: function (a, b) {
        ...
        return this.getSVG(
          q({ chart: { borderRadius: 0 } }, e.chartOptions, b, {
            exporting: {
      ...
      print: function () {
        ...
        if (!a.isPrinting) {
          ...
          if ((p = k && a.chartWidth > k))
            (d = [a.options.chart.width, void 0, !1]), a.setSize(k, void 0, !1);
          h(f, function (a, b) {
            1 === a.nodeType &&
      ...
      contextMenu: function (a, b, e, c, g, f, k) {
            ...
            if (a) {
              ...
              a.separator
                ...
                : ((b = r(
                  ...
                  w(b, t({ cursor: "pointer" }, p.menuItemStyle)));
        ...
        b = { display: "block" };
        e + d.exportMenuWidth > m
          ? (b.right = m - e - g - y + "px")
          : (b.left = e - y + "px");
        c + f + d.exportMenuHeight > q && "top" !== k.alignOptions.verticalAlign
          ? (b.bottom = q - c - y + "px")
          : (b.top = c + f - y + "px");
        w(l, b);
        d.openMenu = !0;
      ...
      addButton: function (a) {
        ...
        if (!1 !== c.enabled) {
          ...
          c.symbol &&
            ((k = e
              .symbol(c.symbol, c.symbolX - p / 2, c.symbolY - p / 2, p, p)
          ...
          d.add().align(
            t(c, { width: d.width, x: C(c.x, b.buttonOffset) }),
            !0,
            "spacingBox"
          );
          b.buttonOffset +=
