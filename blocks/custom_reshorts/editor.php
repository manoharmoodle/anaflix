...
global $CFG, $OUTPUT;
require_once($CFG->dirroot . "/blocks/custom_reshorts/lib.php");

require_login();
$blockinstance = required_param('bui_edit', PARAM_INT);
require_capability(
    "block/custom_reshorts:cancustomizelive",
...
$config = block_custom_reshorts_get_config($blockinstance);
$templatecontext = [];
...
echo $OUTPUT->render_from_template('block_custom_reshorts/blockpage', $templatecontext);
