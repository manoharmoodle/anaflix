...
namespace block_custom_trendingcourses\external;
...
trait set_block_config {
    ...
    public static function set_block_config($instanceid, $blockhtml, $blockcss, $blockjs) {
        ...
        $returnobj->msg = get_string('changessaved', 'block_custom_trendingcourses');

        if (!$blockrecord) {
            $returnobj->status = true;
            $returnobj->msg = get_string('instancenotfound', 'block_custom_trendingcourses');
            return $returnobj;
        }
