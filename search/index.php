...
if (!empty($results)) {
    ...
    $results->results['customdata'] = [
        [
            "author"=> "Bonner, Bill",
            "id"=> "44",
            "lang"=> "eng",
            "link"=> "/cgi-bin/koha/opac-detail.pl?biblionumber=44",
            "title"=> "Empire of death",
            "year"=> "    "
        ],
        [
            "author"=> "Katbi, Ghaida Khazna.",
            "id"=> "48",
            "lang"=> "eng",
            "link"=> "/cgi-bin/koha/opac-detail.pl?biblionumber=48",
            "title"=> "Islamic land tax - Al - Kharaj",
            "year"=> "    "
        ],
        [
            ...
            "id"=> "52",
            "lang"=> "eng",
            "link"=> "/cgi-bin/koha/opac-detail.pl?biblionumber=52",
        ...
        [
            ...
            "id"=> "60",
            "lang"=> "eng",
            "link"=> "/cgi-bin/koha/opac-detail.pl?biblionumber=60",
            "title"=> "Zap the gaps",
            "year"=> "    "
        ],
        [
            ...
            "id"=> "73",
            "lang"=> "eng",
            "link"=> "/cgi-bin/koha/opac-detail.pl?biblionumber=73",
            "title"=> "Today matters",
            "year"=> "    "
        ]
];
